...
namespace ControlePatrimonial.Migrations
{
    public partial class PopulandoTabelas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT INTO Funcionario (Nome, Email, Cep, TipoUsuario, Telefone, Rua, Bairro, Cidade, Complemento, CnpjCpf, EmpresaIdEmpresa, SetorIdSetor, DataCadastro)" +
                                " VALUES  ('Bárbara Pacheco','barbara@gmail.com', '85660000','ADMIN','46999229846','Rua tal mm','bairro tal','Francisco Beltrão','ap 02','08692354945', 1, 1,'20120618 10:34:09 AM')");
            migrationBuilder.Sql("INSERT INTO Funcionario (Nome, Email, Cep, TipoUsuario, Telefone, Rua, Bairro, Cidade, Complemento, CnpjCpf, EmpresaIdEmpresa, SetorIdSetor, DataCadastro)" +
                                " VALUES  ('Sara Vendramini','MICHEL@gmail.com', '8566000','GEREN','46999229846','Rua tal mm','bairro tal','Francisco Beltrão','complementooo','08692354945', 3, 3,'20120618 10:34:09 AM')");
            migrationBuilder.Sql("INSERT INTO Funcionario (Nome, Email, Cep, TipoUsuario, Telefone, Rua, Bairro, Cidade, Complemento, CnpjCpf, EmpresaIdEmpresa, SetorIdSetor, DataCadastro)" +
                                " VALUES  ('Michel','SARA@gmail.com', '8566000','FUNC','46999229846','Rua tal mm','são francisco','Francisco Beltrão','casa dos fundos','08692354945', 2, 2,'20120618 10:34:09 AM')");
